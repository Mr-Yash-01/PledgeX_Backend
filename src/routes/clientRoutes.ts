...
clientRouter.post('/gt',checkSPEmails, checkSPClientEmail, async (req, res) => {
    ...
    try {
        ...
        const txData = {
            ...
            value: amountInWei,
            data: escrowContract.interface.encodeFunctionData("depositFunds", [projectId])
        };
...
clientRouter.post('/sp',checkSPEmails, checkSPClientEmail, async (req, res) => {
    try {
